  ...
  menuItems: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Services & Prices', url: '#pricing' },
        { name: 'Gallery Page', url: '/gallery' },
        { name: 'Gift Cards', url: '/gift-cards' },
        { name: 'Artists + Staff', url: '/team' },
        { name: 'Careers', url: '/careers' },
        { name: 'FAQs Page', url: '/faqs' },
        { name: 'Blog Listing', url: '/blog-listing' },
        { name: 'Single Blog Post', url: '/single-post' },
        { name: 'Booking Page', url: '/booking' },
        { name: 'Contact Us', url: '/contacts' },
        { name: 'Our Locations', url: '/location' },
      ],
    },
    { title: 'Our Services', url: '#about-4', dropdown: false },
